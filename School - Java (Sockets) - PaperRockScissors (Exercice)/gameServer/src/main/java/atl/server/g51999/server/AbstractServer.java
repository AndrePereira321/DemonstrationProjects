...
public abstract class AbstractServer extends Observable implements Runnable {
     ...
     */
    protected final List<ConnectionToClient> threads;
     ...
     */
    synchronized final public List<ConnectionToClient> getClientConnections() {
    ...
    synchronized protected void clientException(
        ...
        this.listeningException(exception);
    }
    ...
    public final void close() throws IOException {
        ...
        try {
            ...
            synchronized (this) {
                for (ConnectionToClient clientThreadList1 : this.getClientConnections()) {
                    try {
                        clientThreadList1.close();
                    } catch (Exception ex) {
                    }
                }
                serverSocket = null;
